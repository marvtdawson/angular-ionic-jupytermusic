...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__index_6826f2f6_js__ = __webpack_require__(537);
                        ...
                        _a.gesture = (_b.sent()).createSwipeBackGesture(this.el, function () { return !!_this.swipeHandler && _this.swipeHandler.canStart() && _this.animationEnabled; }, function () { return _this.swipeHandler && _this.swipeHandler.onStart(); }, function (step) { return _this.ani && _this.ani.progressStep(step); }, function (shouldComplete, step, dur) {
                            if (_this.ani) {
                                ...
                                if (!shouldComplete) {
                                    ...
                                    newStepValue += Object(__WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["b" /* g */])(new __WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["a" /* P */](0, 0), new __WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["a" /* P */](1, 0), new __WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["a" /* P */](0.68, 0.28), new __WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["a" /* P */](1, 1), step);
                                }
                                else {
                                    newStepValue += Object(__WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["b" /* g */])(new __WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["a" /* P */](0, 0), new __WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["a" /* P */](0.32, 0.72), new __WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["a" /* P */](0, 1), new __WEBPACK_IMPORTED_MODULE_8__cubic_bezier_2812fda3_js__["a" /* P */](1, 1), step);
                                }
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __generator */])(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_7__index_6826f2f6_js__["e" /* t */])(Object.assign({ mode: mode,
                                animated: animated,
