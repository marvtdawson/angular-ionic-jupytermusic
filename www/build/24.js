...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__index_624eea58_js__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__ = __webpack_require__(272);
...
var Menu = /** @class */ (function () {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __generator */])(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */]._register(this);
                        _a = this;
    ...
    class_1.prototype.disconnectedCallback = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */]._unregister(this);
        if (this.animation) {
    ...
    class_1.prototype.setOpen = function (shouldOpen, animated) {
        if (animated === void 0) { animated = true; }
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */]._setOpen(this, shouldOpen, animated);
    };
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __generator */])(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */]._createAnimation(this.type, this)];
                    case 1:
                        // Create new animation
    ...
    class_1.prototype.canStart = function (detail) {
        ...
        else if (__WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */]._getOpenSync()) {
            return false;
        }
    ...
    class_1.prototype.updateState = function () {
        ...
        if (!this.disabled) {
            __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */]._setActiveMenu(this);
        }
...
var updateVisibility = function (menu) { return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __awaiter */])(void 0, void 0, void 0, function () {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __generator */])(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].get(menu)];
            case 1:
                menuEl = _b.sent();
                _a = menuEl;
...
var MenuButton = /** @class */ (function () {
    function class_2(hostRef) {
        ...
        this.onClick = function () { return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __awaiter */])(_this, void 0, void 0, function () {
            return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __generator */])(this, function (_a) {
                return [2 /*return*/, __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].toggle(this.menu)];
            });
        }); };
    }
...
var MenuController = /** @class */ (function () {
    ...
    class_3.prototype.open = function (menu) {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].open(menu);
    };
    /**
    ...
    class_3.prototype.close = function (menu) {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].close(menu);
    };
    /**
    ...
    class_3.prototype.toggle = function (menu) {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].toggle(menu);
    };
    /**
    ...
    class_3.prototype.enable = function (enable, menu) {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].enable(enable, menu);
    };
    /**
    ...
    class_3.prototype.swipeGesture = function (enable, menu) {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].swipeGesture(enable, menu);
    };
    /**
    ...
    class_3.prototype.isOpen = function (menu) {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].isOpen(menu);
    };
    /**
    ...
    class_3.prototype.isEnabled = function (menu) {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].isEnabled(menu);
    };
    /**
    ...
    class_3.prototype.get = function (menu) {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].get(menu);
    };
    /**
     * Get the instance of the opened menu. Returns `null` if a menu is not found.
     */
    class_3.prototype.getOpen = function () {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].getOpen();
    };
    /**
     * Get all menu instances.
     */
    class_3.prototype.getMenus = function () {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].getMenus();
    };
    /**
    ...
    class_3.prototype.isAnimating = function () {
        return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].isAnimating();
    };
    /**
    ...
    class_3.prototype.registerAnimation = function (name, animation) {
        return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __awaiter */])(this, void 0, void 0, function () {
            return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __generator */])(this, function (_a) {
                return [2 /*return*/, __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].registerAnimation(name, animation)];
            });
        });
    };
    return class_3;
...
var MenuToggle = /** @class */ (function () {
    function class_4(hostRef) {
        ...
        this.onClick = function () {
            return __WEBPACK_IMPORTED_MODULE_6__index_72775737_js__["a" /* m */].toggle(_this.menu);
        };
    }
