...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__index_35276576_js__ = __webpack_require__(537);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__ = __webpack_require__(539);
...
var Nav = /** @class */ (function () {
    ...
    class_1.prototype.componentDidUnload = function () {
        for (var _i = 0, _a = this.views; _i < _a.length; _i++) {
            var view = _a[_i];
            Object(__WEBPACK_IMPORTED_MODULE_6__index_35276576_js__["b" /* l */])(view.element, __WEBPACK_IMPORTED_MODULE_4__constants_3c3e1099_js__["e" /* d */]);
            view._destroy();
        }
        if (this.gesture) {
    ...
    class_1.prototype.postViewInit = function (enteringView, leavingView, ti) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (var _a = 0, destroyQueue_1 = destroyQueue; _a < destroyQueue_1.length; _a++) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_6__index_35276576_js__["b" /* l */])(view.element, __WEBPACK_IMPORTED_MODULE_4__constants_3c3e1099_js__["c" /* b */]);
                Object(__WEBPACK_IMPORTED_MODULE_6__index_35276576_js__["b" /* l */])(view.element, __WEBPACK_IMPORTED_MODULE_4__constants_3c3e1099_js__["d" /* c */]);
                Object(__WEBPACK_IMPORTED_MODULE_6__index_35276576_js__["b" /* l */])(view.element, __WEBPACK_IMPORTED_MODULE_4__constants_3c3e1099_js__["e" /* d */]);
            }
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __generator */])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_6__index_35276576_js__["d" /* t */])(animationOpts)];
                    case 1:
    ...
    class_1.prototype.cleanup = function (activeView) {
        ...
        for (var i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                ...
                // let's unload it
                Object(__WEBPACK_IMPORTED_MODULE_6__index_35276576_js__["b" /* l */])(element, __WEBPACK_IMPORTED_MODULE_4__constants_3c3e1099_js__["e" /* d */]);
                this.destroyView(view);
            }
            else if (i < activeViewIndex) {
                // this view comes before the active view
                // and it is not a portal then ensure it is hidden
                Object(__WEBPACK_IMPORTED_MODULE_6__index_35276576_js__["c" /* s */])(element, true);
            }
        }
    };
    ...
    class_1.prototype.onEnd = function (shouldComplete, stepValue, dur) {
        ...
        if (this.sbAni) {
            ...
            if (!shouldComplete) {
                ...
                newStepValue += Object(__WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["b" /* g */])(new __WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["a" /* P */](0, 0), new __WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["a" /* P */](1, 0), new __WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["a" /* P */](0.68, 0.28), new __WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["a" /* P */](1, 1), stepValue);
            }
            else {
                newStepValue += Object(__WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["b" /* g */])(new __WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["a" /* P */](0, 0), new __WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["a" /* P */](0.32, 0.72), new __WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["a" /* P */](0, 1), new __WEBPACK_IMPORTED_MODULE_7__cubic_bezier_fc4a068b_js__["a" /* P */](1, 1), stepValue);
            }
