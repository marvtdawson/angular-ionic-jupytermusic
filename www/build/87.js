...
var startTapClick = function (config) {
    ...
    var onTouchStart = function (ev) {
        lastTouch = Object(__WEBPACK_IMPORTED_MODULE_0__helpers_46f4a262_js__["i" /* n */])(ev);
        pointerDown(ev);
    };
    ...
    var onMouseDown = function (ev) {
        var t = Object(__WEBPACK_IMPORTED_MODULE_0__helpers_46f4a262_js__["i" /* n */])(ev) - MOUSE_WAIT;
        if (lastTouch < t) {
            pointerDown(ev);
        }
    };
    ...
    var setActivatedElement = function (el, ev) {
        ...
        clearTimeout(activeDefer);
        activeDefer = undefined;
        var _a = Object(__WEBPACK_IMPORTED_MODULE_0__helpers_46f4a262_js__["j" /* p */])(ev), x = _a.x, y = _a.y;
        // deactivate selected
        if (activatableEle) {
