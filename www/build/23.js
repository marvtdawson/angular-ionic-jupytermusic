...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__overlays_10640d86_js__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__theme_18cbe2cc_js__ = __webpack_require__(534);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__haptic_c8f1473e_js__ = __webpack_require__(538);
...
var Datetime = /** @class */ (function () {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __generator */])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_5__overlays_10640d86_js__["o" /* p */].create(pickerOptions)];
                    case 1:
                        picker = _a.sent();
                        ...
                        picker.addEventListener('ionPickerColChange', function (event) { return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __awaiter */])(_this, void 0, void 0, function () {
    ...
    class_1.prototype.validateColumn = function (columns, name, index, min, max, lowerBounds, upperBounds) {
        ...
        var selectedIndex = column.selectedIndex = Object(__WEBPACK_IMPORTED_MODULE_3__helpers_46f4a262_js__["c"])(indexMin, column.selectedIndex, indexMax);
    ...
    class_1.prototype.render = function () {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_3__helpers_46f4a262_js__["a"])(true, el, this.name, this.value, this.disabled);
        return (Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["a" /* H */], { onClick: this.onClick, role: "combobox", "aria-disabled": disabled ? 'true' : null, "aria-expanded": "" + isExpanded, "aria-haspopup": "true", "aria-labelledby": labelId, class: (_a = {},
                _a[mode] = true,
                _a['datetime-disabled'] = disabled,
                _a['datetime-readonly'] = readonly,
                _a['datetime-placeholder'] = addPlaceholderClass,
                _a['in-item'] = Object(__WEBPACK_IMPORTED_MODULE_6__theme_18cbe2cc_js__["c" /* h */])('ion-item', el),
                _a) }, Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: "datetime-text" }, datetimeText), Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: function (btnEl) { return _this.buttonEl = btnEl; } })));
    };
...
var Picker = /** @class */ (function () {
    function class_2(hostRef) {
        ...
        this.didPresent = Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["d" /* c */])(this, "ionPickerDidPresent", 7);
        this.willPresent = Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["d" /* c */])(this, "ionPickerWillPresent", 7);
        this.willDismiss = Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["d" /* c */])(this, "ionPickerWillDismiss", 7);
        this.didDismiss = Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["d" /* c */])(this, "ionPickerDidDismiss", 7);
    }
    /**
    ...
    class_2.prototype.present = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __awaiter */])(this, void 0, void 0, function () {
            ...
            return Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __generator */])(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_5__overlays_10640d86_js__["f" /* e */])(this, 'pickerEnter', iosEnterAnimation, iosEnterAnimation, undefined)];
                    case 1:
                        _a.sent();
                        if (this.duration > 0) {
    ...
    class_2.prototype.dismiss = function (data, role) {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_5__overlays_10640d86_js__["g" /* f */])(this, data, role, 'pickerLeave', iosLeaveAnimation, iosLeaveAnimation);
    };
    /**
     * Returns a promise that resolves when the picker did dismiss.
     */
    class_2.prototype.onDidDismiss = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_5__overlays_10640d86_js__["h" /* g */])(this.el, 'ionPickerDidDismiss');
    };
    /**
     * Returns a promise that resolves when the picker will dismiss.
     */
    class_2.prototype.onWillDismiss = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_5__overlays_10640d86_js__["h" /* g */])(this.el, 'ionPickerWillDismiss');
    };
    /**
    ...
    class_2.prototype.buttonClick = function (button) {
        ...
        var shouldDismiss = Object(__WEBPACK_IMPORTED_MODULE_5__overlays_10640d86_js__["p" /* s */])(button.handler, this.getSelected()) !== false;
        if (shouldDismiss) {
            return this.dismiss();
        }
    ...
    class_2.prototype.render = function () {
        ...
        var _this = this;
        var mode = Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["e" /* d */])(this);
        return (Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["a" /* H */], { "aria-modal": "true", class: Object.assign((_a = {}, _a[mode] = true, 
            // Used internally for styling
            _a["picker-" + mode] = true, _a), Object(__WEBPACK_IMPORTED_MODULE_6__theme_18cbe2cc_js__["b" /* g */])(this.cssClass)), style: {
                zIndex: "" + (20000 + this.overlayIndex)
            }, onIonBackdropTap: this.onBackdropTap }, Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("ion-backdrop", { visible: this.showBackdrop, tappable: this.backdropDismiss }), Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: "picker-wrapper", role: "dialog" }, Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: "picker-toolbar" }, this.buttons.map(function (b) { return (Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: buttonWrapperClass(b) }, Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("button", { type: "button", onClick: function () { return _this.buttonClick(b); }, class: buttonClass(b) }, b.text))); })), Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: "picker-columns" }, Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: "picker-above-highlight" }), this.presented && this.columns.map(function (c) { return Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("ion-picker-column", { col: c }); }), Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: "picker-below-highlight" })))));
    };
...
var buttonClass = function (button) {
    return Object.assign({ 'picker-button': true, 'ion-activatable': true }, Object(__WEBPACK_IMPORTED_MODULE_6__theme_18cbe2cc_js__["b" /* g */])(button.cssClass));
};
var PickerColumnCmp = /** @class */ (function () {
    function class_3(hostRef) {
        ...
        this.y = 0;
        this.noAnimate = true;
        this.ionPickerColChange = Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["d" /* c */])(this, "ionPickerColChange", 7);
    }
    ...
    class_3.prototype.update = function (y, duration, saveY) {
        ...
        if (this.lastIndex !== selectedIndex) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_7__haptic_c8f1473e_js__["b"])();
    ...
    class_3.prototype.onEnd = function (detail) {
        ...
        this.velocity = Object(__WEBPACK_IMPORTED_MODULE_3__helpers_46f4a262_js__["c"])(-MAX_PICKER_SPEED, detail.velocityY * 23, MAX_PICKER_SPEED);
    ...
    class_3.prototype.refresh = function (forceRefresh) {
        ...
        var selectedIndex = Object(__WEBPACK_IMPORTED_MODULE_3__helpers_46f4a262_js__["c"])(min, this.col.selectedIndex || 0, max);
    ...
    class_3.prototype.render = function () {
        ...
        return (Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["a" /* H */], { class: (_a = {},
            ...
            } }, col.prefix && (Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: "picker-prefix", style: { width: col.prefixWidth } }, col.prefix)), Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: "picker-opts", style: { maxWidth: col.optionsWidth }, ref: function (el) { return _this.optsEl = el; } }, col.options.map(function (o, index) { return Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])(Button, { type: "button", class: { 'picker-opt': true, 'picker-opt-disabled': !!o.disabled }, "opt-index": index }, o.text); })), col.suffix && (Object(__WEBPACK_IMPORTED_MODULE_1__core_ca0488fc_js__["i" /* h */])("div", { class: "picker-suffix", style: { width: col.suffixWidth } }, col.suffix))));
    };
