...
var SwiperClass = /** @class */ (function () {
    ...
    SwiperClass.use = function (module) {
        ...
        return Class.installModule.apply(Class, Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["j" /* __spreadArrays */])([module], params));
    };
    return SwiperClass;
}());
function updateSize() {
...
var Swiper = /** @class */ (function (_super) {
    Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __extends */])(Swiper, _super);
    function Swiper() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
